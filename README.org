...
window#waybar {
    border-bottom: 4px solid #AFAF87; 
    background: #262626;
}
...
#+begin_src conf :mkdirp yes :tangle configs/sway/config
  ...
  set $base_bg     #262626
  set $sunset      #D9967D
  set $saucer_grey #AFAF87
  set $abduct_green #98C379
  set $text_light  #E0E0E0

  # class                 border       background  text         indicator     child_border
  client.focused          $sunset      $base_bg    $text_light  $sunset       $sunset
  client.focused_inactive $base_bg     $base_bg    $saucer_grey $base_bg      $base_bg
  client.unfocused        $base_bg     $base_bg    #585858      $base_bg      $base_bg
  client.urgent           $abduct_green $base_bg   $text_light  $abduct_green $abduct_green
  client.placeholder      $base_bg     $base_bg    $saucer_grey $base_bg      $base_bg
  ...
  output * bg ~/Pictures/Wallpapers/wallhaven-d836qg.jpg fill
