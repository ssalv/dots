...
#+BEGIN_SRC toml :mkdirp yes :tangle configs/foot/foot.ini
  ...
  workers=14
  font=iMWritingMono Nerd Font:size=13
  pad=16x16 center
...
*{
    font-family: "iMWritingDuo Nerd Font", "IBM Plex Serif", "BlexMono Nerd Font", monospace;
    font-size: 13pt;
    margin: 0;
    padding: 0;
}
...
#custom-intro {
    font-size: 14pt;
    background-image: url('/home/ssalva/Pictures/Wallpapers/Gentoo.svg');
