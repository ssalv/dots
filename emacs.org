...
#+begin_src emacs-lisp :mkdirp yes :tangle configs/emacs/init.el
  ...
  (setenv "SSH_AUTH_SOCK" 
          (concat (getenv "XDG_RUNTIME_DIR") "/ssh-agent.socket"))
...
Roam,C-c n f,Find (or create) a Node,"""Node Find"""
Roam,C-c n i,Insert a link to a Node,"""Node Insert"""
Roam,C-c n d t,Open Dailies for Today,"""Daily Today"""
Agenda,C-c [,Add current file to Agenda,"""Push to front"""
Agenda,C-c ],Remove current file from Agenda,"""Pop from stack"""
Agenda,C-c a,Open Agenda View,"""Agenda"""
  ...
  #+begin_src emacs-lisp :tangle configs/emacs/init.el
    ...
    (setq org-agenda-files
          (list "/home/ssalva/Notes/roam/daily"
                "/home/ssalva/Notes/roam/inbox.org"))
    (global-set-key (kbd "C-c a") 'org-agenda)
    (setq org-todo-keywords
          '((sequence "TODO(t)" "PROG(p)" "REVIEW(r)" "|" "DONE(d)")))

    ;; Optional: Make them colorful so they are easy to spot
